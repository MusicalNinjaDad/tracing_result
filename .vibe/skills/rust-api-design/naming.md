...
[`str::as_bytes()`]: https://doc.rust-lang.org/std/primitive.str.md#method.as_bytes
[`Path::to_str`]: https://doc.rust-lang.org/std/path/struct.Path.md#method.to_str
[`str::to_lowercase()`]: https://doc.rust-lang.org/std/primitive.str.md#method.to_lowercase
[`f64::to_radians()`]: https://doc.rust-lang.org/std/primitive.f64.md#method.to_radians
[`String::into_bytes()`]: https://doc.rust-lang.org/std/string/struct.String.md#method.into_bytes
[`BufReader::into_inner()`]: https://doc.rust-lang.org/std/io/struct.BufReader.md#method.into_inner
[`BufWriter::into_inner()`]: https://doc.rust-lang.org/std/io/struct.BufWriter.md#method.into_inner
...
[`BufReader`]: https://doc.rust-lang.org/std/io/struct.BufReader.md#method.into_inner
[`GzDecoder`]: https://docs.rs/flate2/0.2.19/flate2/read/struct.GzDecoder.md#method.into_inner
[`AtomicBool`]: https://doc.rust-lang.org/std/sync/atomic/struct.AtomicBool.md#method.into_inner
...
[`Vec::as_mut_slice`]: https://doc.rust-lang.org/std/vec/struct.Vec.md#method.as_mut_slice
...
- [`Result::as_ref`](https://doc.rust-lang.org/std/result/enum.Result.md#method.as_ref)
- [`RefCell::as_ptr`](https://doc.rust-lang.org/std/cell/struct.RefCell.md#method.as_ptr)
- [`slice::to_vec`](https://doc.rust-lang.org/std/primitive.slice.md#method.to_vec)
- [`Option::into_iter`](https://doc.rust-lang.org/std/option/enum.Option.md#method.into_iter)
...
[`Cell::get`]: https://doc.rust-lang.org/std/cell/struct.Cell.md#method.get
...
The difference between getters and conversions ([C-CONV](naming.md#c-conv)) can be subtle
...
[`TempDir::path`]: https://docs.rs/tempdir/0.3.5/tempdir/struct.TempDir.md#method.path
[`TempDir::into_path`]: https://docs.rs/tempdir/0.3.5/tempdir/struct.TempDir.md#method.into_path

### Examples from the standard library

- [`std::io::Cursor::get_mut`](https://doc.rust-lang.org/std/io/struct.Cursor.md#method.get_mut)
- [`std::pin::Pin::get_mut`](https://doc.rust-lang.org/std/pin/struct.Pin.md#method.get_mut)
- [`std::sync::PoisonError::get_mut`](https://doc.rust-lang.org/std/sync/struct.PoisonError.md#method.get_mut)
- [`std::sync::atomic::AtomicBool::get_mut`](https://doc.rust-lang.org/std/sync/atomic/struct.AtomicBool.md#method.get_mut)
- [`std::collections::hash_map::OccupiedEntry::get_mut`](https://doc.rust-lang.org/std/collections/hash_map/struct.OccupiedEntry.md#method.get_mut)
- [`<[T]>::get_unchecked`](https://doc.rust-lang.org/std/primitive.slice.md#method.get_unchecked)
...
[`str::bytes`]: https://doc.rust-lang.org/std/primitive.str.md#method.bytes
[`str::chars`]: https://doc.rust-lang.org/std/primitive.str.md#method.chars
...
- [`Vec::iter`](https://doc.rust-lang.org/std/vec/struct.Vec.md#method.iter)
- [`Vec::iter_mut`](https://doc.rust-lang.org/std/vec/struct.Vec.md#method.iter_mut)
- [`Vec::into_iter`](https://doc.rust-lang.org/std/vec/struct.Vec.md#method.into_iter)
- [`BTreeMap::iter`](https://doc.rust-lang.org/std/collections/struct.BTreeMap.md#method.iter)
- [`BTreeMap::iter_mut`](https://doc.rust-lang.org/std/collections/struct.BTreeMap.md#method.iter_mut)
...
[`Vec::into_iter`]: https://doc.rust-lang.org/std/vec/struct.Vec.md#method.into_iter
[vec::IntoIter]: https://doc.rust-lang.org/std/vec/struct.IntoIter.html
[`BTreeMap::keys`]: https://doc.rust-lang.org/std/collections/struct.BTreeMap.md#method.keys
[btree_map::Keys]: https://doc.rust-lang.org/std/collections/btree_map/struct.Keys.html
[`BTreeMap::values`]: https://doc.rust-lang.org/std/collections/struct.BTreeMap.md#method.values
...
[Cargo feature]: http://doc.crates.io/manifest.md#the-features-section
